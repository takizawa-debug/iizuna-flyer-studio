                ...
                <div className="flex flex-col gap-3 print:break-after-page print:gap-0">
                    ...
                    >
                        ...
                        <div className="w-[280px] h-full relative z-10 flex flex-col pt-[45px] pb-[35px] px-[28px] text-ink print:border-none overflow-hidden">
                            ...
                            {/* Dynamic Absolute Background Apple Silhouette */}
                            <div className="absolute -bottom-[60px] -right-[50px] w-[240px] h-[240px] opacity-[0.08] pointer-events-none z-0 transform rotate-[-15deg] transition-colors duration-500">
