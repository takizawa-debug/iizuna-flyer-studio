           ...
           ========================================================= */}
                <div className="flex flex-col gap-3 print:break-after-page print:gap-0">
                    ...
                    >
                        ...
                        <div className="w-[280px] h-full relative z-10 flex flex-col pt-[45px] pb-[35px] px-[28px] text-ink print:border-none overflow-hidden">

                            {/* Dynamic Absolute Background Apple Tree Silhouette */}
                            <div className="absolute -bottom-[20px] -right-[50px] w-[280px] h-[280px] opacity-[0.05] pointer-events-none z-0 transform rotate-[-5deg] transition-colors duration-500">
                                <svg viewBox="0 0 512 512" fill={coverColor === '#FFFFFF' ? '#E88C83' : coverColor} xmlns="http://www.w3.org/2000/svg">
                                    <path d="M285.5 352.4c-8.9 29.8-19.1 58.7-32.3 86.8-5.3 11.2-11.4 22.1-18.7 32.5-4 5.7-9.5 10.6-13.8 16.2-1.9 2.5-6.5 4.8-10 5.1-17.7 1.4-35.4 0-53-0.7-3.7-0.1-9-3.7-10.4-7.1-11-25.2-14.8-52.1-13-79.6 1.4-22 8.4-42.6 19.1-61.9 9.3-16.7 20-32.3 32-47.3 11.9-14.8 24.3-29.2 38.2-42.4 2.1-2 5.1-3 7.7-4.5 1.5 2.1 3 4.2 4.4 6.3 7 10 14.1 20 21.4 29.8 8.1 11.1 16.7 21.8 25.1 32.6 1.1 1.4 1 3.5 1.3 5.3 1 5.9 1 11.8 2 17.7 0 3.8 0 7.7 0 11.2zM218.4 222.6c-17.7 11.2-34.9 23-51.5 35.7-19.4 14.8-38 30.7-55.5 47.6-16.3 15.6-32.3 31.5-47 48.6-6.8 7.9-12.7 16.6-18.8 25.1-1.7 2.4-1.2 5.3-1.6 8 4.2-0.5 8.7-0.4 12.8-1.5 24.5-6.6 48.7-14.2 72.8-22 36.6-11.8 72.7-25 108.8-38 6.4-2.3 12.4-6.3 18.5-9.6-1.5-26.6-9.5-51.3-24.3-74.1-4.2-6.5-9.5-12.4-14.2-19.8zM260.6 230.1c16.3-4.4 31.9-10.8 47.9-16.1 15.6-5.2 31.7-9.1 47.8-12.6 12-2.7 24-5 36.2-7 1.6-0.3 3.9 1.1 5.7 2 35.8 17.6 71.3 35.5 106.9 53.4 1.2 0.6 2.4 1.2 3.8 1.9-4.2 3.6-8.3 7.3-12.6 10.8-10.8 8.8-22.3 16.9-33.6 25-18.1 12.9-36.5 25.6-54.8 38.3-20.1 14-40.2 27.9-61.1 40.8-1.5 0.9-4.5-0.1-6.7-0.8-22.9-7.1-39.6-22.1-51.5-43.4-12.6-22.5-18.5-47-22.1-72.3-1.4-10-1.7-20-2.6-29.8-1-1.2-1.8-2.3-2.6-3.4h-0.7c0-23.3 0-46.6 0-69.9-0.7-10.7-0.8-21.4-1.9-31.9-1.4-14.1-5.1-27.7-10-40.8-2.3-6.1-5.6-11.8-8.8-18.1 10.9 9.1 19.3 20.2 27.1 31.9 11.2 16.7 18 35.2 23.3 54.5 5 18 5 36.6 5 55.4-0.1 16 0 32.1-0.1 48.1 0 0-0.1 0-0.1 0zM128.5 220.7c20.3-6.6 38.9-16.4 56.4-28.7 17.4-12.2 33.3-26.6 48.1-42 6.6-6.9 12.8-14.6 18.2-22.5 15.6-23.2 26-48.4 29.8-76 1-7.1 1.4-14.4 2-21.7 0.1-1.6 0-3.3 0-5.1-4.7 1.9-8.4 4.5-11.9 7.6-22.7 20-38 44.5-47.5 73.2-6.4 19.3-10 39.4-10.4 59.8-0.2 11.5 1 22.8 2.6 34.1 0.7 4.7 2 9.3 3.1 13.9 0 0 0.1 0 0.2 0-9.8 4.7-19.8 9.2-29.6 14.1-15.6 7.7-31.3 14.9-46.7 22.5-5 2.5-9.6 6-14.4 9.1 0.1 1 0.2 1.6 0.2 2.2-0.5 4.3 0 8.6-1.5 12.8 1.4-1 2.2-1.9 3.2-2.5 10.1-5.8 20.5-11.2 30.5-17.1 15-8.8 30-17.8 44.6-27.4-3.5 15.5-11.3 28.5-22.4 39.6-11.2 11.1-24.1 19.3-39.2 24.3-11.2 3.7-22.7 6-34.6 6.3l-1.4 0.1c-1.4-0.1-2.9-0.8-4.2-0.6-0.5 0.1-0.9 1.1-1.3 1.7 0.9 1.5 1.5 3.3 2.7 4.5 17.1 15.2 36.3 26.6 57.8 33.8 26.6 8.8 54 11.8 81.9 9.9 5.8-0.4 11.5-1.5 17.1-2.8 3.5-0.8 6.9-2.3 10.4-3.5 3.5-1.2 7-2.3 10.8-3.6-10.4-17-21.5-33.8-33.2-50.5-9.3-13.3-19.4-26.1-30.8-37.9-10.2-10.5-22.2-19.2-34-28-11.6-8.6-23.7-16.4-35.9-24-3.8-2.4-8-4.1-12.1-6 2.3-4.8 5.6-7.8 9.9-10 6.6-3.4 13.6-5.8 20.8-7.7 13.9-3.7 28.1-5 42.5-3.8 17.8 1.5 34.6 7.4 50 16.9 14.2 8.7 26.4 19.8 36.7 32.8 5.4 6.8 9.8 14.2 14.2 21.6 2.1 3.5 3.5 7.6 5.5 12.3zM252.1 63.6c4.2 5.5 8.3 10.1 11.7 15.1 8.8 12.7 14.6 26.8 17 42.1 1.7 11.1 2.3 22.3 1.2 33.6-0.7 7-1.4 14.1-2.4 21.2-1 6.8-2.6 13.5-4.2 20.1-1-0.1-1.9-0.2-2.9-0.3-4.2-25.2-12.4-49.3-24.9-71.9-8.4-15.3-18.4-29.4-29.6-42.3-6.4-7.4-13.5-14.2-20.7-20.9-4-3.7-8.7-6.8-13.1-10.2 4-0.1 8 0.1 11.9-0.4 13.5-1.5 26.8 0 39.5 5.5 5.7 2.4 11.1 5.6 16.5 8.4zM161.4 100.8c-0.1-4.7 0.9-9.1 1.5-13.6 4.7-32.9 20.3-60.6 46.5-80.9 9.3-7.2 19.3-13.3 30.2-17.8 3.5-1.4 7-2.6 10.5-3.8 0.1 2.4 0.6 4.8 0.2 7.1-2.4 14.1-9 26.4-18.8 37.1-14.6 15.9-31.9 28.4-50.5 38.6-6 3.3-11.9 6.6-18.1 9.4-0.5 0.1-1.2 0.5-1.5 1.4z" />
                                </svg>
                            </div>
