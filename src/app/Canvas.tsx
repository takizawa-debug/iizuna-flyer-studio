                ...
                <div className="flex flex-col gap-3 print:break-after-page print:gap-0">
                    ...
                    >
                        ...
                        <div className="w-[280px] h-full relative z-10 flex flex-col pt-[45px] pb-[35px] px-[28px] text-ink print:border-none">
                            ...
                            {/* Dynamic Absolute Background Apple Tree Silhouette - Moved to bleed out of this specific container */}
                            <div className="absolute -bottom-[60px] -left-[80px] w-[450px] h-[450px] opacity-[0.07] pointer-events-none z-0 transition-colors duration-500">
