...
export async function GET(req: NextRequest) {
    ...
    try {
        ...
        // Capture panels as high-resolution screenshots (deviceScaleFactor: 5 = ~360 DPI)
        // This produces rasterized images with NO fonts in the PDF — eliminates all font embedding issues
